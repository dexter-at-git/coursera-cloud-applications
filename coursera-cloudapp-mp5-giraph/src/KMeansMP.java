...
public final class KMeansMP {
	...
	private static class ClusterCars implements
			PairFunction<Tuple2<String, Vector>, Integer, String> {
	...
	public static void main(String[] args) {
		...
		int runs = 1;
		long seed = 0;
		KMeansModel model = KMeans.train(points.rdd(), k, maxIterations, runs,
				KMeans.RANDOM(), seed);
		JavaPairRDD<Integer, Iterable<String>> clusters = titles.zip(points)
				.mapToPair(new ClusterCars(model)).groupByKey();
