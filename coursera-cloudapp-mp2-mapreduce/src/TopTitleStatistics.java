...
public class TopTitleStatistics extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new TopTitleStatistics(),
				args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		...
		FileOutputFormat.setOutputPath(jobB,
				new Path(args[1]));
	...
	public static class TitleCountMap extends
		...
		protected void setup(Context context) throws IOException,
			...
			this.stopWords = Arrays.asList(readHDFSFile(stopWordsPath, conf)
					.split("\n"));
		...
		public void map(Object key, Text value, Context context)
			...
			while (itr.hasMoreTokens()) {
				String cleanWord = itr.nextToken().toLowerCase();
	...
	public static class TitleCountReduce extends
	...
	public static class TopTitlesStatMap extends
	...
	public static class TopTitlesStatReduce extends
